...
Isadmin=$(curl -sS https://raw.githubusercontent.com/Anang11042000/permission/main/access  | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/Anang11042000/permission/main/access  | grep $MYIP | awk '{print $3}')
fi
...
wget -qO- https://raw.githubusercontent.com/Anang11042000/bot_panel/aio/BotAPI.sh >/etc/.maAsiss/.Shellbtsss
}
